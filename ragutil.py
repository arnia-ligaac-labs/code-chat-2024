...
def get_index(): #creates and returns an in-memory vector store to be used in the application
    ...
    # pdf_path = "/workspace/items.txt" #assumes local PDF file with this name
    pdf_path = "/workspace/letters/2022-Shareholder-Letter.pdf" #assumes local PDF file with this name
    # loader = TextLoader(file_path=pdf_path) #load the pdf file
